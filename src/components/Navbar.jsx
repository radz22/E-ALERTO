...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 bg-white shadow-md sticky top-0 z-20'>
        ...
        {userData ? 
            <div className='w-8 h-8 md:flex justify-center items-center rounded-full bg-black text-white relative group hidden'>
